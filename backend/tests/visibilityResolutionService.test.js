...
test("project visibility predicate keeps non-routed ownership on canonical project fields", () => {
  ...
  assert.doesNotMatch(sql, /p\.(?:team_lead_id|project_leader_id|department_id)/);
});
