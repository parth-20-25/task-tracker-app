...
const PERMISSIONS = {
  ...
  DESIGN_FIXTURE_OUTSOURCE_OVERRIDE: "design.fixture.outsource.override",
...
const DESIGN_OUTSOURCE_ADMIN_PERMISSION_IDS = [
...
const DESIGN_OUTSOURCE_MANAGER_PERMISSION_IDS = [
  PERMISSIONS.DESIGN_FIXTURE_OUTSOURCE,
  PERMISSIONS.DESIGN_FIXTURE_OUTSOURCE_BULK,
  PERMISSIONS.DESIGN_FIXTURE_OUTSOURCE_MANAGE,
  PERMISSIONS.DESIGN_FIXTURE_OUTSOURCE_CANCEL,
...
const DESIGN_OUTSOURCE_ROLE_PERMISSION_BUNDLES = {
  r1: DESIGN_OUTSOURCE_ADMIN_PERMISSION_IDS,
  r2: DESIGN_OUTSOURCE_ADMIN_PERMISSION_IDS,
  r3: DESIGN_OUTSOURCE_MANAGER_PERMISSION_IDS,
  r4: DESIGN_OUTSOURCE_MANAGER_PERMISSION_IDS,
  r5: [PERMISSIONS.DESIGN_FIXTURE_OUTSOURCE_REVIEW],
};
...
const PERMISSION_DEFINITIONS = [
  ...
  [PERMISSIONS.DESIGN_FIXTURE_OUTSOURCE, "Outsource Design Fixture Stages", "Allows outsourcing eligible Design fixture workflow stages."],
  [PERMISSIONS.DESIGN_FIXTURE_OUTSOURCE_BULK, "Bulk Outsource Design Fixture Stages", "Allows outsourcing eligible Design fixture workflow stages in bulk."],
  [PERMISSIONS.DESIGN_FIXTURE_OUTSOURCE_MANAGE, "Manage Design Fixture Outsourcing", "Allows managing Design fixture outsourcing assignments and conversions."],
  [PERMISSIONS.DESIGN_FIXTURE_OUTSOURCE_CANCEL, "Cancel Design Fixture Outsourcing", "Allows cancelling active Design fixture outsourcing assignments."],
  [PERMISSIONS.DESIGN_FIXTURE_OUTSOURCE_REVIEW, "Review Design Fixture Outsourcing", "Allows internal review of submitted Design fixture outsourcing work."],
  [PERMISSIONS.DESIGN_FIXTURE_OUTSOURCE_OVERRIDE, "Override Design Fixture Outsourcing Conversion", "Allows converting started internal Design work to outsourcing when a reason is recorded."],
  [PERMISSIONS.DESIGN_VENDOR_MANAGE, "Manage Design Vendors", "Allows creating and maintaining Design outsourcing vendors."],
...
module.exports = {
  ...
  DESIGN_OUTSOURCE_ADMIN_PERMISSION_IDS,
  DESIGN_OUTSOURCE_MANAGER_PERMISSION_IDS,
