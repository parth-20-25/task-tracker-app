...
import { RouteContentSkeleton, TaskGridSkeleton } from '@/components/LoadingSkeletons';
...
function OperationalDashboard() {
  ...
  const safeTasks = isProjectFirstRole
    ? []
    : (rawTasks ?? []).filter((task) => task.task_type !== "additional_design");
