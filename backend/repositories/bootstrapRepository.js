...
async function ensureTasksTable(client) {
  ...
  const taskColumnStatements = [
    ...
    `ALTER TABLE tasks ADD COLUMN IF NOT EXISTS scope_type TEXT`,
    `ALTER TABLE tasks ADD COLUMN IF NOT EXISTS completion_task_code TEXT`,
    `ALTER TABLE tasks ADD COLUMN IF NOT EXISTS completion_task_revision INTEGER`,
    `ALTER TABLE tasks ADD COLUMN IF NOT EXISTS completion_task_display_name TEXT`,
    `ALTER TABLE tasks ADD COLUMN IF NOT EXISTS completion_task_outsource_supplier TEXT`,
    `ALTER TABLE tasks ADD COLUMN IF NOT EXISTS completion_task_not_required_reason TEXT`,
    `ALTER TABLE tasks ADD COLUMN IF NOT EXISTS completion_task_not_required_by VARCHAR(50)`,
    `ALTER TABLE tasks ADD COLUMN IF NOT EXISTS completion_task_not_required_at TIMESTAMPTZ`,
    `ALTER TABLE tasks ADD COLUMN IF NOT EXISTS cancelled_by VARCHAR(50)`,
  ...
  `, "idx_tasks_additional_design_project_scope");
